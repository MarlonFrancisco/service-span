...
import { ArrowLeft, CalendarDays, Clock, TrendingUp, Users } from "lucide-react";
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Salão Elegância - Maria Silva</p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl text-[#1a2b4c]">{dashboardMetrics.upcomingAppointments}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl text-[#1a2b4c]">{dashboardMetrics.monthlyTotal}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl text-[#1a2b4c]">R$ {dashboardMetrics.weeklyRevenue.toLocaleString()}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl text-[#1a2b4c]">{dashboardMetrics.averageRating}</div>
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">
              ...
              <span className="ml-2">
                <span className="inline-block w-3 h-3 bg-[#20b2aa] rounded mr-1"></span>Livre
                <span className="inline-block w-3 h-3 bg-[#1a2b4c] rounded mr-1 ml-3"></span>Agendado
                <span className="inline-block w-3 h-3 bg-gray-400 rounded mr-1 ml-3"></span>Bloqueado
              </span>
            </p>
          </CardHeader>
          <CardContent>
