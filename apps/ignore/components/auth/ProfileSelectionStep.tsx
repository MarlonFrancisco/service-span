    ...
    <div className="bg-white rounded-2xl overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-100 text-center">
        ...
        <p className="text-gray-600">
          Escolha a opção que melhor descreve como você pretende usar o
          ServiceSnap
        </p>
      </div>
      ...
      <div className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Buscar e agendar serviços como salão de beleza, consultórios,
                personal trainers e muito mais
              </p>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-[#1a2b4c] mb-1">
                Quero oferecer meus serviços
              </h3>
              <p className="text-sm text-gray-600 mb-3">
                Cadastrar minha empresa, gerenciar agendamentos e alcançar novos
