      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Estamos aqui para ajudar. Entre em contato e responderemos em até 24
            horas.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
            {/* Contact Details */}
            <Card className="p-6">
              <h3 className="text-xl text-[#1a2b4c] mb-4">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:suporte@servicesnap.com"
                      className="text-gray-600 hover:text-[#20b2aa]"
                    >
            ...
            <Card className="p-6 bg-gradient-to-br from-[#20b2aa]/10 to-[#1a2b4c]/10">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Talvez sua dúvida já tenha sido respondida em nossa central de
                ajuda.
              </p>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <p className="text-green-700 text-sm">
                Respondemos todas as mensagens em até <strong>24 horas</strong>{' '}
                durante dias úteis.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            ...
            <p className="text-red-700 text-sm mb-4">
              Para questões urgentes relacionadas a segurança ou problemas
              técnicos críticos, entre em contato imediatamente:
            </p>
            <a
