          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <Card className="p-6 border-l-4 border-l-[#20b2aa]">
              ...
              <p className="text-gray-600 text-sm">
                Seus dados pessoais são protegidos com criptografia de ponta a
                ponta e não são vendidos para terceiros.
              </p>
            </Card>
            ...
            <Card className="p-6 border-l-4 border-l-[#1a2b4c]">
              ...
              <p className="text-gray-600 text-sm">
                Você tem controle total sobre seus dados e pode solicitar
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <Card className="p-4">
                  <h4 className="text-lg text-[#1a2b4c] mb-2">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                <li>
                  <strong>Com prestadores de serviços:</strong> Para facilitar
                  agendamentos (nome, contato)
                </li>
                <li>
                ...
                <li>
                  <strong>Requisições legais:</strong> Quando exigido por lei ou
                  autoridades competentes
                </li>
                <li>
                  <strong>Proteção de direitos:</strong> Para proteger nossos
                  direitos legais e dos usuários
                </li>
              </ul>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <Card className="p-4 text-center">
                  ...
                  <p className="text-xs text-gray-600">
                    SSL/TLS para todas as transmissões
                  </p>
                </Card>
                ...
                <Card className="p-4 text-center">
                  ...
                  <p className="text-xs text-gray-600">
                    Servidores seguros e acesso restrito
                  </p>
                </Card>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Solicitar informações sobre quais dados pessoais temos
                      sobre você
                    </p>
                  </div>
                </div>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Os cookies nos ajudam a lembrar suas preferências, manter você
                logado e fornecer conteúdo personalizado.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                cumprir os propósitos descritos nesta política, exceto quando um
                período de retenção mais longo for exigido por lei.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Dados de agendamentos são mantidos por 5 anos para fins fiscais
                e de suporte ao cliente.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-2 text-gray-700">
                  <p>
                    <strong>E-mail:</strong> privacidade@servicesnap.com
                  </p>
                  <p>
                    <strong>Telefone:</strong> (11) 3000-0000
                  </p>
                  <p>
                    <strong>Endereço:</strong> Rua da Privacidade, 123 - São
                    Paulo, SP
                  </p>
                </div>
