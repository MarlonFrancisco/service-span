...
export function TemplateShowcase() {
  const [emailVariant, setEmailVariant] = useState<'standard' | 'withMessage'>('standard');
  const [smsVariant, setSmsVariant] = useState<'standard' | 'withMessage'>('standard');
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-3xl text-[#1a2b4c]">Templates de Comunicação ServiceSnap</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Demonstração dos templates de e-mail e SMS utilizados no sistema de notificações automáticas 
            para confirmação de agendamentos e lembretes.
          </p>
        ...
        <Tabs defaultValue="email" className="w-full">
          <TabsList className="grid w-full grid-cols-2 max-w-md mx-auto">
            <TabsTrigger value="email" className="data-[state=active]:bg-[#1a2b4c] data-[state=active]:text-white">
              📧 Template de E-mail
            </TabsTrigger>
            <TabsTrigger value="sms" className="data-[state=active]:bg-[#1a2b4c] data-[state=active]:text-white">
              📱 Template de SMS
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="email" className="space-y-6">
            <Card className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-xl text-[#1a2b4c] mb-2">Template de Confirmação por E-mail</h2>
                ...
                <div className="flex gap-2">
                  <Button
                    variant={emailVariant === 'standard' ? 'default' : 'outline'}
                    size="sm"
                    onClick={() => setEmailVariant('standard')}
                    className={emailVariant === 'standard' 
                  ...
                  <Button
                    variant={emailVariant === 'withMessage' ? 'default' : 'outline'}
                    size="sm"
                    onClick={() => setEmailVariant('withMessage')}
                    className={emailVariant === 'withMessage' 
                      ? 'bg-[#20b2aa] hover:bg-[#20b2aa]/90 text-white' 
                      : 'border-gray-300'
                    }
                  >
              ...
              <div className="bg-gray-100 p-6 rounded-lg">
                <EmailConfirmationTemplate
                  customMessage={emailVariant === 'withMessage' 
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">Otimizado para mobile e desktop</p>
                </div>
                <div className="text-center">
                  <div className="text-[#20b2aa] text-2xl mb-2">✨</div>
                  <h4 className="text-[#1a2b4c] mb-1">Customizável</h4>
                  <p className="text-gray-600 text-sm">Mensagem personalizada opcional</p>
                </div>
                <div className="text-center">
                  <div className="text-[#20b2aa] text-2xl mb-2">🔗</div>
                  <h4 className="text-[#1a2b4c] mb-1">Ações Diretas</h4>
                  <p className="text-gray-600 text-sm">Links para calendário e reagendamento</p>
                </div>
              </div>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="sms" className="space-y-6">
            <Card className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-xl text-[#1a2b4c] mb-2">Template de Lembrete por SMS</h2>
                  <p className="text-gray-600">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    variant={smsVariant === 'withMessage' ? 'default' : 'outline'}
                    size="sm"
                    onClick={() => setSmsVariant('withMessage')}
                    className={smsVariant === 'withMessage' 
                      ? 'bg-[#20b2aa] hover:bg-[#20b2aa]/90 text-white' 
                      : 'border-gray-300'
                    }
                  >
              ...
              <div className="bg-gray-100 p-6 rounded-lg">
                <SmsReminderTemplate
                  customMessage={smsVariant === 'withMessage' 
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">Máximo de 160 caracteres</p>
                </div>
                <div className="text-center">
                  <div className="text-[#20b2aa] text-2xl mb-2">💰</div>
                  <h4 className="text-[#1a2b4c] mb-1">Controle de Custo</h4>
                  <p className="text-gray-600 text-sm">Avisos sobre mensagens longas</p>
                </div>
                <div className="text-center">
                  <div className="text-[#20b2aa] text-2xl mb-2">🔗</div>
                  <h4 className="text-[#1a2b4c] mb-1">Link Direto</h4>
                  <p className="text-gray-600 text-sm">Acesso rápido para alterações</p>
                </div>
              </div>
            </Card>
          </TabsContent>
        ...
        <Card className="p-6">
          <h3 className="text-lg text-[#1a2b4c] mb-4">Especificações Técnicas</h3>
