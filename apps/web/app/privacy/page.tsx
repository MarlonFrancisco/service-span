      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-gray max-w-none">
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-2xl text-[#1a2b4c] mb-4">1. Informações Gerais</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Esta Política de Privacidade descreve como o ServiceSnap coleta, usa, armazena e protege suas informações pessoais.
                Respeitamos sua privacidade e estamos comprometidos em proteger seus dados pessoais.
              </p>
            </section>

            <section>
              <h2 className="text-2xl text-[#1a2b4c] mb-4">2. Informações que Coletamos</h2>
              <h3 className="text-xl text-[#1a2b4c] mb-3">2.1 Informações Fornecidas por Você</h3>
              ...
              <h3 className="text-xl text-[#1a2b4c] mb-3">2.2 Informações Coletadas Automaticamente</h3>
            ...
            <section>
              <h2 className="text-2xl text-[#1a2b4c] mb-4">3. Como Usamos suas Informações</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl text-[#1a2b4c] mb-4">4. Compartilhamento de Informações</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Não vendemos ou alugamos suas informações pessoais. Podemos compartilhar seus dados apenas nas seguintes situações:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <section>
              <h2 className="text-2xl text-[#1a2b4c] mb-4">5. Segurança dos Dados</h2>
              <p className="text-gray-700 leading-relaxed">
                Implementamos medidas de segurança técnicas, administrativas e físicas apropriadas para proteger suas informações pessoais contra acesso não autorizado, alteração, divulgação ou destruição.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Para exercer seus direitos ou esclarecer dúvidas sobre esta Política de Privacidade, entre em contato conosco através do e-mail: <a href="mailto:privacy@servicesnap.com" className="text-[#20b2aa] hover:underline">privacy@servicesnap.com</a>
              </p>
            </section>
